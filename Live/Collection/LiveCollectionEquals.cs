...
namespace Vertigo.Live
{
    ...
    {
        public static ILiveValue<bool> IsEqual<T>(this ILiveCollection<T> source1, ILiveCollection<T> source2)
        {
            LiveObserver<ICollectionState<T, ICollectionDelta<T>>> observer1 = null;
            LiveObserver<ICollectionState<T, ICollectionDelta<T>>> observer2 = null;
