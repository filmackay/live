...
{
    public class LiveSortedListInner<TKey, TValue> : LiveCollectionInner<KeyValuePair<TKey, TValue>, ISet<KeyValuePair<TKey, TValue>>, ISetDelta<KeyValuePair<TKey, TValue>>, SetDelta<KeyValuePair<TKey, TValue>>, LiveSortedListInner<TKey, TValue>>, IList<T>
    {
