...
namespace Vertigo
{
    ...
    public class LinqDebugLog : TextWriter
    {
        private bool isOpen;
        ...
        public LinqDebugLog(int level, string category)
        ...
        public LinqDebugLog(int level, string category, IFormatProvider formatProvider)
            : base(formatProvider)
        {
            this.level = level;
